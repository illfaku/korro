...
/**
 * Collection of methods for <a href="http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html">
 ...
 */
class ConfigOptions(config: Config) {

  /**
   * Searches for `scala.Boolean` at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getBoolean-java.lang.String-
   */
  def findBoolean(path: String):Option[Boolean] = lookupValue(path, config.getBoolean)

  /**
   * Searches for `java.lang.Number` at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getNumber-java.lang.String-
   */
  def findNumber(path: String): Option[Number] = lookupValue(path, config.getNumber)

  /**
   * Searches for `scala.Int` at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getInt-java.lang.String-
   */
  def findInt(path: String): Option[Int] = lookupValue(path, config.getInt)

  /**
   * Searches for `scala.Long` at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getLong-java.lang.String-
   */
  def findLong(path: String): Option[Long] = lookupValue(path, config.getLong)

  /**
   * Searches for `scala.Double` at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getDouble-java.lang.String-
   */
  def findDouble(path: String): Option[Double] = lookupValue(path, config.getDouble)

  /**
   * Searches for `java.lang.String` at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getString-java.lang.String-
   */
  def findString(path: String): Option[String] = lookupValue(path, config.getString)

  /**
   * Searches for <a href="http://lightbend.github.io/config/latest/api/com/typesafe/config/ConfigObject.html">
   * `ConfigObject`</a> at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getObject-java.lang.String-
   */
  def findObject(path: String): Option[ConfigObject] = lookupValue(path, config.getObject)

  /**
   * Searches for <a href="http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html">`Config`</a>
   * at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getConfig-java.lang.String-
   */
  def findConfig(path: String): Option[Config] = lookupValue(path, config.getConfig)

  /**
   * Searches for <a href="http://lightbend.github.io/config/latest/api/com/typesafe/config/ConfigValue.html">
   * `ConfigValue`</a> at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getValue-java.lang.String-
   */
   ...
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getBytes-java.lang.String-
   */
  ...
  /**
   * Searches for <a href="http://lightbend.github.io/config/latest/api/com/typesafe/config/ConfigList.html">
   * `ConfigList`</a> at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getList-java.lang.String-
   */
  def findList(path: String): Option[ConfigList] = lookupValue(path, config.getList)

  /**
   * Searches for `scala.Boolean` list at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getBooleanList-java.lang.String-
   */
   ...
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getNumberList-java.lang.String-
   */
  def findNumberList(path: String): List[Number] = lookupList(path, config.getNumberList)

  /**
   * Searches for `scala.Int` list at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getIntList-java.lang.String-
   */
   ...
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getLongList-java.lang.String-
   */
   ...
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getDoubleList-java.lang.String-
   */
   ...
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getStringList-java.lang.String-
   */
   ...
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getObjectList-java.lang.String-
   */
   ...
   * Searches for <a href="http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html">`Config`</a>
   * list at path.
   * @see http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html#getConfigList-java.lang.String-
   */
  ...
  /**
   * Searches for associative array with string keys and
   * <a href="http://lightbend.github.io/config/latest/api/com/typesafe/config/Config.html">`Config`</a> values at path.
   */
  def findConfigMap(path: String): Map[String, Config] = {
    findObject(path) map { obj =>
      obj.keySet.asScala.flatMap(x => findConfig(path + "." + x).map(x -> _)).toMap
    } getOrElse Map.empty
  }
